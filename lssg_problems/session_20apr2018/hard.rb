#######
# with method. don't do this (too easy)
...
#########
# this does not work. think about algorithm more

# Given an array of `numbers`
# Find the maximum number in the array
# Find if any 3 numbers inside the array multiply to get the max number in array.
#
# input: array
# output: boolean
# rules: return true if
#   any 3 numbers in the array multiply to max number of the array
#
# data structure
#   array

# algorithm
# 1 find the max number //this is easy enough
# 2 find if any products of 3 numbers == max
#    -
#    -
# 3 if so stop and return true
...
#######
## this will work if you add the if statement
=begin
algorithm
  - store the maximum number into a variable to compare against
  - find all possible 3-way multiples and store the numbers in another way
    - start iteration over the array until the third to last element
      - use index and multiply current number with the number at next index as well as the one after that
  - see if any of the numbers in the new array match the maximum number
    - return true if yes
    - return false if no
=end
...
############
### working solution plus explanation
=begin
