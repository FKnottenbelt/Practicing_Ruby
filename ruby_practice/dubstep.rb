...
remix of this song, Polycarpus inserts a certain number of words "WUB"
before the first word of the song (the number may be zero), after the last
word (the number may be zero), and between words (at least one between any
...
p song_decoder("QWUBQQWUBIWUBWWWUBJOPJPBRH") =="Q QQ I WW JOPJPBRH"
p song_decoder("") == ""
